...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'GH个人博客', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的恰饭程序员🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://reksai.link', // 网站地址
